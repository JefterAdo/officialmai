    ...
    <footer class="footer mt-auto py-5 bg-dark text-white">
        <div class="container">
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6">
                    <h5 class="text-primary mb-3">MILITER</h5>
                ...
                <div class="col-lg-4 col-md-6">
                    <h5 class="text-primary mb-3">NOUS CONTACTER</h5>
                    <p class="mb-3"><i class="fas fa-envelope me-2"></i>contact@rhdpofficiel.ci</p>
                    <h5 class="text-primary mb-3">NOUS SUIVRE</h5>
            ...
            <div class="text-center">
                ...
                <p class="text-muted mb-0">© <script>document.write(new Date().getFullYear())</script> RHDP - Tous droits réservés</p>
            </div>
        </div>
    </footer>
